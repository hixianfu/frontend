    ...
    <PaperProvider>
      <ThemedContainer>
        ...
        <View style={styles.stats}>
          <Stats title="Posts" value={25} />
          <Stats title="Followers" value={200} />
          <Stats title="Following" value={420} />
        </View>
        <ThemedCell title="我的收藏" icon={<Icon source="chevron-right" size={24} color="#000" />} />
